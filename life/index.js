...
//Decide how large each cell will be
var cellSize = 15; //width in pixels
var bottomMargin = 100; //leave 100 pizxels on the ground
//Figure out how many cells to show on the page
var viewWidthInCells = Math.floor((pageWidth - 20) / cellSize); //
var viewHeightInCells = Math.floor((pageHeight - bottomMargin) / cellSize);
...
var view = new View(viewWidthInCells, viewHeightInCells, cellSize);
var block = 0;
var isPaused = false;
